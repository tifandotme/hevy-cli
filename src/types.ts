...
type JsonContent<T> = T extends { content: { "application/json": infer Body } } ? Body : unknown;
...
type SuccessResponseObject<P extends ApiPath, M extends ApiMethod<P>> = ResponseMap<
  P,
  M
>[keyof ResponseMap<P, M> & SuccessStatus];

export type ApiResponse<P extends ApiPath, M extends ApiMethod<P>> = JsonContent<
  SuccessResponseObject<P, M>
>;
